...
#define PRINT_OK() p2s_print_color(COL_GREEN, "OK\n")
#define PRINT_OK_PROMPT(fmt, ...) p2s_print_color(COL_GREEN, "\n\n" fmt "\n\r\n", ## __VA_ARGS__)
#define PRINT_ERR(fmt, ...) p2s_print_color(COL_RED, "NOK: " fmt "\n", ## __VA_ARGS__)
#define PRINT_ERR_PROMPT(fmt, ...) p2s_print_color(COL_RED, "\n\nNOK: " fmt "\n\r\n", ## __VA_ARGS__)
