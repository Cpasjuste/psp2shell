...
if(WIN32)
    set(CMAKE_C_COMPILER "${VITASDK}/bin/arm-vita-eabi-gcc.exe")
    set(CMAKE_CXX_COMPILER "${VITASDK}/bin/arm-vita-eabi-g++.exe")
    set(CMAKE_AR "${VITASDK}/bin/arm-vita-eabi-ar.exe" CACHE STRING "")
    set(CMAKE_RANLIB "${VITASDK}/bin/arm-vita-eabi-ranlib.exe" CACHE STRING "")
else()
